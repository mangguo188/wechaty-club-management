 ...
 */
exports.EventTypeRev = {};
for (const key in wechaty_grpc_1.EventType) {
    const val = wechaty_grpc_1.EventType[key];
    exports.EventTypeRev[val] = key;
}
