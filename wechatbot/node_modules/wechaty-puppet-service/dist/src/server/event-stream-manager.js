...
class EventStreamManager {
    ...
    start(stream) {
        ...
        if (this.puppet.logonoff()) {
            ...
            this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_LOGIN, payload);
        }
    }
    stop() {
    ...
    obj) {
        ...
        const response = new wechaty_grpc_1.EventResponse();
    ...
    connectPuppetEventToStreamingCall() {
        ...
        const disconnect = () => {
            config_1.log.verbose('EventStreamManager', 'connectPuppetEventToStreamingCall() disconnect() %s callbacks', offCallbackList.length);
        ...
        for (const eventName of eventNameList) {
            ...
            switch (eventName) {
                case 'dong': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_DONG, payload);
                ...
                case 'dirty': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_DIRTY, payload);
                ...
                case 'error': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_ERROR, payload);
                ...
                case 'heartbeat': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_HEARTBEAT, payload);
                ...
                case 'friendship': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_FRIENDSHIP, payload);
                ...
                case 'login': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_LOGIN, payload);
                ...
                case 'logout': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_LOGOUT, payload);
                ...
                case 'message': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_MESSAGE, payload);
                ...
                case 'ready': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_READY, payload);
                ...
                case 'room-invite': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_ROOM_INVITE, payload);
                ...
                case 'room-join': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_ROOM_JOIN, payload);
                ...
                case 'room-leave': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_ROOM_LEAVE, payload);
                ...
                case 'room-topic': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_ROOM_TOPIC, payload);
                ...
                case 'scan': {
                    const listener = (payload) => this.grpcEmit(wechaty_grpc_1.EventType.EVENT_TYPE_SCAN, payload);
