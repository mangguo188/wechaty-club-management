...
import { Brolog, VERSION, } from './brolog';
...
t.test('Brolog static/instance construct test', (t) => {
...
t.test('Brolog individual instance prefix filter test', (t) => __awaiter(void 0, void 0, void 0, function* () {
...
t.test('Brolog enableLogger()', sinonTest(function (t) {
    return __awaiter(this, void 0, void 0, function* () {
        const sandbox = sinon.createSandbox();
        const spy = sandbox.spy();
        const stub = sandbox.stub(Brolog.prototype, 'defaultTextPrinter');
        t.test('enableLogging(false/true)', (t) => __awaiter(this, void 0, void 0, function* () {
            spy.resetHistory();
            stub.resetHistory();
        ...
        t.test('enableLogging(log function)', (t) => __awaiter(this, void 0, void 0, function* () {
            spy.resetHistory();
            stub.resetHistory();
