...
export class FriendshipAddRequest extends jspb.Message {
  ...
  hasSourceRoomId(): boolean;
  clearSourceRoomId(): void;
  getSourceRoomId(): google_protobuf_wrappers_pb.StringValue | undefined;
  setSourceRoomId(value?: google_protobuf_wrappers_pb.StringValue): void;

  hasSourceContactId(): boolean;
  clearSourceContactId(): void;
  getSourceContactId(): google_protobuf_wrappers_pb.StringValue | undefined;
  setSourceContactId(value?: google_protobuf_wrappers_pb.StringValue): void;
...
export namespace FriendshipAddRequest {
  export type AsObject = {
    contactId: string,
    hello: string,
    sourceRoomId?: google_protobuf_wrappers_pb.StringValue.AsObject,
    sourceContactId?: google_protobuf_wrappers_pb.StringValue.AsObject,
  }
}
