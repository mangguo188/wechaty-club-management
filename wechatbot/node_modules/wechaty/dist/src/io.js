...
class Io {
    constructor(options) {
        ...
        this.eventBuffer = [];
        this.state = new wechaty_puppet_1.StateSwitch('Io', { log: config_1.log });
        ...
        this.protocol = options.protocol + '|' + options.wechaty.id + '|' + config_1.config.serviceIp + '|' + options.servicePort;
