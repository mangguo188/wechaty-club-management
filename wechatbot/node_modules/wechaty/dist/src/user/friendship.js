...
class Friendship extends events_1.EventEmitter {
    ...
    static get wechaty() { throw new Error('This class can not be used directly. See: https://github.com/wechaty/wechaty/issues/2027'); }
    get wechaty() { throw new Error('This class can not be used directly. See: https://github.com/wechaty/wechaty/issues/2027'); }
    /**
     * @ignore
     */
    static load(id) {
    ...
    static async search(queryFilter) {
        config_1.log.verbose('Friendship', 'static search("%s")', JSON.stringify(queryFilter));
    ...
    static async add(contact, options) {
        var _a;
        config_1.log.verbose('Friendship', 'static add(%s, %s)', contact.id, typeof options === 'string' ? options : options.hello);
        if (typeof options === 'string') {
            config_1.log.warn('Friendship', 'the params hello is deprecated in the next version, please put the attr hello into options object, e.g. { hello: "xxxx" }');
            await this.wechaty.puppet.friendshipAdd(contact.id, { hello: options });
        }
        else {
            const friendOption = {
                contactId: (_a = options === null || options === void 0 ? void 0 : options.contact) === null || _a === void 0 ? void 0 : _a.id,
                hello: options.hello,
