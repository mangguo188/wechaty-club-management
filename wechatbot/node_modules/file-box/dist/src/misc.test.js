...
tstest_1.test('dataUrl to base64', async (t) => {
    const base64 = [
...
tstest_1.test('httpHeadHeader', async (t) => {
...
tstest_1.test('httpStream', async (t) => {
    const URL = 'https://httpbin.org/headers';
    const MOL_KEY = 'Mol';
    const MOL_VAL = '42';
    const headers = {};
    headers[MOL_KEY] = MOL_VAL;
    const res = await misc_1.httpStream(URL, headers);
    const buffer = await misc_1.streamToBuffer(res);
