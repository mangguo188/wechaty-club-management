...
const chunker_transform_stream_1 = require("./pure-functions/chunker-transform-stream");
...
class FileBox {
    ...
    async syncRemoteName() {
        ...
        const headers = await misc_1.httpHeadHeader(this.remoteUrl);
    ...
    transformBufferToStream(buffer) {
         ...
         */
        return bufferStream.pipe(chunker_transform_stream_1.chunkerTransformStream());
    }
    ...
    async toBuffer() {
        ...
        this.pipe(stream);
        const buffer = await misc_1.streamToBuffer(stream);
        return buffer;
    }
    async toQRCode() {
        ...
        const qrValue = await qrcode_1.bufferToQrValue(buf);
        return qrValue;
    }
    /**
     *
