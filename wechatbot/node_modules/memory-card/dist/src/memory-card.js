...
const mod_1 = require("./storage/mod");
...
class MemoryCard {
    ...
    getStorage() {
        ...
        const storage = mod_1.getStorage(this.options.name, this.options.storageOptions);
        return storage;
    }
    load() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.isMultiplex()) {
                config_1.log.verbose('MemoryCard', 'load() should not be called on a multiplex MemoryCard. NOOP');
                return;
            }
            if (this.payload) {
