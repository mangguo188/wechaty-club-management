...
blue_tape_1.default.skip('storage huawei obs load/save', (t) => __awaiter(void 0, void 0, void 0, function* () {
    const EXPECTED_KEY = 'key';
    const EXPECTED_VAL = 'val';
    const NAME = Math.random().toString().substr(2);
    const storageOptions = {
    ...
    yield cardB.load();
    t.equal(yield cardB.get(EXPECTED_KEY), EXPECTED_VAL, 'should get val back from obs');
    yield card.destroy();
    yield cardB.destroy();
}));
